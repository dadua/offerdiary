...
public class WebConstatnts {
	public static final String FLOWER_PARAM = "flower";
	public static final String FLOWER_ID_PARAM = "flower_id";
	public static final String FLOWER_IDS_PARAM = "flower_ids";
	public static final String FLOWER_SEARCH_STRING_PARAM = "q";
