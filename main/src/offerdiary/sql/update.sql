...
update OFFERS set FEEDER_REPUTATION = 20 where FEEDER_REPUTATION is null and IS_PUBLIC=0;
update OFFERS set FEEDER_REPUTATION = 10 where FEEDER_REPUTATION is null and IS_PUBLIC=1;
