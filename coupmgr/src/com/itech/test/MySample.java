	...
	public static void main_inner() throws Exception {
		...
		while (!quit) {
			...
			if      (choice.equals("")) {
				...
				whoAmI(orkad);
			} else if (choice.equals("lsf")) {
				listFriends(orkad);
			} else if (choice.equals("lsac")) {
				listActivities(orkad);
			} else if (choice.equals("ups")) {
				updateStatus(orkad);
			} else if (choice.equals("gp")) {
				getFullProfile(orkad);
			} else if (choice.equals("gbn")) {
				getBirthdayNotifications(orkad);
			} else if (choice.equals("pac")) {
				postNewActivity(orkad);
			} else if (choice.equals("lssc")) {
				getScraps(orkad);
			} else if (choice.equals("psc")) {
				writeScrap(orkad);
			} else if (choice.equals("lsal")) {
				listAlbums(orkad);
			} else if (choice.equals("cral")) {
				createAlbum(orkad);
			} else if (choice.equals("rmal")) {
				deleteAlbum(orkad);
			} else if (choice.equals("lsph")) {
				listPhotos(orkad);
			} else if (choice.equals("upph")) {
				uploadPhoto(orkad);
